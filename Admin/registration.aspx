<%@ Page Title="" Language="VB" MasterPageFile="~/Admin/AdminMaster2.master" AutoEventWireup="false" CodeFile="registration.aspx.vb" Inherits="Admin_registration" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <head>
    ...
    <body>
		    <!-- inner banner -->
		    <div class="inner-banner text-center text-white"></div>
		    <!-- //inner banner -->
            <!-- contact -->
